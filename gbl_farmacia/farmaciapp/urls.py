...
urlpatterns = patterns('',
        ...
        url(r'^aukera_menua/medikamentu_kontsulta/medikamentu_bilaketa/medikamentua/(?P<medikamentua_ident>\w+)/unitateak_kendu/$', views.medikamentuaren_unitateak_ezabatu, name='medikamentuari_unitateak_kendu'),
